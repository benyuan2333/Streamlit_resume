...
- **武汉科技大学城市学院 - 本科 - 计算机科学与技术**  
  2020.09 - 2024.06  
  专业排名：:blue-background[前10%] &nbsp;
  成绩优异，21年获得 中国大学生计算机设计大赛 :blue-background[省二等奖]  
...
- **奇点临近技术（上海）有限公司 - 软件实习**  
  ...
  骑行App运动路书开发，收集并清洗标注对接api接口存放数据库。  
  高尔夫App球场数据开发，gis绘制Shp，转换geojson以及开发所需json格式。
  球场数据多重数据分析可视化审核，逆向数据以及OSM开源数据采集。  
...
with col5:
    st.write("""
    **爬虫:** 
    - 使用Python编写爬虫程序，通过分析网页和逆向API接口的源码实现数据抓取
